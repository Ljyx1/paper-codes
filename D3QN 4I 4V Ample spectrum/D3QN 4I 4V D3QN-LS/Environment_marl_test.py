...
class Environ:
    ...
    def __init__(self, down_lane, up_lane, left_lane, right_lane, width, height, n_veh, n_neighbor,n_RB):
        ...
        # self.bandwidth = 1500
        self.demand_size = int((4 * 190 + 300) * 8 * 10)  # V2V payload: 1060 Bytes every 100 ms
        # self.demand_size = 20
    ...
    def Compute_Performance_Reward_Train(self, actions_power):
        ...
        V2I_Signals = 10 ** ((self.V2I_power_dB - self.V2I_channels_with_fastfading.diagonal() +
                              self.vehAntGain + self.bsAntGain - self.bsNoiseFigure) / 10)
    ...
    def Compute_Performance_Reward_Test_sarl(self, actions_power):
        ...
        self.active_links_sarl[np.multiply(self.active_links_sarl,
                                           self.demand_sarl <= 0)] = 0  # transmission finished, turned to "inactive"
    ...
    def Compute_Performance_Reward_Test_dpra(self, actions_power):
        ...
        self.active_links_dpra[np.multiply(self.active_links_dpra,
                                           self.demand_dpra <= 0)] = 0  # transmission finished, turned to "inactive"
    ...
    def new_random_game(self, n_Veh=0):
        ...
        self.individual_time_limit = (self.time_slow / 2) * np.ones((self.n_Veh, self.n_neighbor))
